...
dotnet new web -o ./src/$ProjectModule.Host
...
dotnet add ./src/$ProjectModule.Application.Contracts/$ProjectModule.Application.Contracts.csproj package IdentityModel
...
dotnet add ./src/$ProjectModule.Host/$ProjectModule.Host.csproj package IdentityServer4.AccessTokenValidation
